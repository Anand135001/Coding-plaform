...
const generateUploadSignture = async (req, res) => {
    try {
    ...
    const publicId = `codeRoots-solutions/${problemId}/${userId}_${timestamp}`;
...
const deleteVideo = async (req, res) => {
    ...
    // deleting video form Cloudinary
    await cloudinary.uploader.destroy(video.cloudinaryPublicId, { resource_type: 'video' , invalidate: true });
    // deleting video form DB
...
module.exports = { generateUploadSignture, saveVideoMetaData, deleteVideo};